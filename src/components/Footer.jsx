  ...
  return (
    <footer className="bg-gray-900 text-white px-6 md:px-16 lg:px-28 py-12 space-y-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        {/* About Section */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-amber-300 font-mexon">
        ...
        {/* Quick Links */}
        <div>
          <h2 className="text-xl font-bold mb-4 font-alphatron text-lime-200">
            QUICK LINKS
          </h2>
          <ul className="space-y-2 text-sm">
            {[
              ...
              <li key={index}>
                <a
                  href={link.href}
                  className="text-[#39FF14] hover:text-[#39FF14] hover:underline transition-colors duration-300"
                >
                  {link.name}
                </a>
              </li>
        ...
        <div className="space-y-4">
          ...
          <ul className="text-gray-300 text-sm space-y-2">
            <li className="flex items-center gap-2">
              ...
              <a
                ...
                className="hover:text-[#39FF14] hover:underline transition-colors duration-300"
              >
                +91 965222202
              </a>
            </li>
          ...
          <div className="flex gap-4 mt-4">
            <a href="#" className="text-gray-300 hover:text-blue-500 text-xl transition-colors duration-300"><FaFacebookF /></a>
            <a href="#" className="text-gray-300 hover:text-pink-500 text-xl transition-colors duration-300"><FaInstagram /></a>
            <a href="#" className="text-gray-300 hover:text-green-500 text-xl transition-colors duration-300"><FaWhatsapp /></a>
            <a href="#" className="text-gray-300 hover:text-red-500 text-xl transition-colors duration-300"><FaYoutube /></a>
          </div>
        </div>
      </div>
      ...
      <div className="mt-12">
        ...
        <div className="w-full h-64 overflow-hidden rounded-lg border border-gray-700">
          <iframe
            title="Our Location"
